...
class Njh:
    ...
    def _calculate_N(self, w1, context):
        #TODO: code here
        center = self.window_size[0]
        context_df = self.context_holder[self.context_holder[self.context_holder.columns[center]] == context]

    def _calculate_conditional_P(self, w1, w2):
        #TODO: code here
        """Calculates P(w1|w2)"""
        self._calculate_N(w1, w2)
        

    def _calculate_similarity(self, w1_index, w2_index):
        #TODO: code here
        """Calculates S(w1,w2)"""
        self._calculate_conditional_P(self.uniques[w1_index], self.uniques[w2_index])
        

x = time()
Njh('./corpus.txt', window_size=[2,1])
